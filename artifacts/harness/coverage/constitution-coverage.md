...
| D34 | ### D34 amendment — Ordered kept-set JPEG export |  |  |  |  |  | NOT-COVERED |
...
| D36 | Anti-irritant + rejects endgame *(amended by R-M.1)* | `cp2_lr_round_trip`<br>`f06_data_safety_bounded` | `ShootDecisionJournalTests.testD36_journalBesideShootNotCentralCatalog`<br>`ShootDecisionJournalTests.testD36_journalDoesNotTouchPhotographFiles`<br>`ShootSidecarStoreTests.testD36_writeOpenXMPBesideOriginal`<br>`ShootSidecarStoreTests.testD36_readForeignXMPPreservesUnknownFields`<br>`ShootSidecarStoreTests.testD36_lrRoundTripSurvivesReimport`<br>`ShootSidecarStoreTests.testD35_reconciliationSessionWinsOnExternalDrift`<br>`P0SidecarIntegrationTests.testD36_sessionEditCommitWritesSidecarBesideOriginal`<br>`P0SidecarIntegrationTests.testD35_sidecarDriftDetectedWithoutMutatingSessionRecipe`<br>`ShootCrashRecoveryTests.testD13_stagedScopeGoneAfterCrashRecovery`<br>`SidecarAuthorityTests.testCase1_cleanShutdownXMPAndShootCacheAgree`<br>`SidecarAuthorityTests.testCase2_journalNewerThanSidecarWinsCrashWindow`<br>`SidecarAuthorityTests.testCase3_sidecarNewerThanShootCacheWins`<br>`SidecarAuthorityTests.testCase4_externalXMPChangeDetectedNotOverwritten`<br>`SidecarAuthorityTests.testCase5_shootCacheWithoutSidecarKeepsRecipe`<br>`SidecarAuthorityTests.testCase6_deletedApplicationSupportReconstructsFromXMP`<br>`SidecarAuthorityTests.testCase7_sourceDriveReturnReconcilesSidecar`<br>`SidecarAuthorityTests.testEditThenXMPThenRestart`<br>`SidecarAuthorityTests.testEditCrashWindowJournalReplayThenRestart`<br>`SidecarAuthorityTests.testStaleShootCacheCannotOverrideNewerSidecarOnFolderReopen`<br>`SidecarAuthorityTests.testPersistenceRemainsSerializedThroughShootStore` |  |  |  |  |
