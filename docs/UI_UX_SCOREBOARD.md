...
| UX03 | 1 / M1a | FAIL | Zero wrong geometry: all quarter-turns, centered/off-center crops, portrait/landscape/square; retain R gate | [Prompt 0](0-baseline-handoff.md) reproduces 270° candidate mismatch with durable native photograph PNG and selected fallback records. Historical [U U1](UI_CHECK_REPORT.md#u1--p1-intended-rotationcrop-can-be-hidden-by-browse-fallback) includes correct 90° TIFF. Graph proof does not cover Canvas selection. |
| UX04 | 1 / M1a | PARTIAL | 500 controlled transitions/run; zero wrong assets/new superseded promotions; bounded age of retained valid frame | [U](UI_CHECK_REPORT.md) sampled navigation worked; no transient identity-correlated 500-transition proof. Source race around awaited cache insertion remains a hypothesis. |
| UX05 | 1 / M1a | FAIL | No blank after valid preview; unchanged recipe edges ≤1 physical pixel at 1×/2× | [U U3](UI_CHECK_REPORT.md#u3--p2-promotion-box-shifts-and-intermediate-tier-not-observed): box [28,61.5,1064,711]→[28,62.5,1064,709]. Session nil is not proof of visible blank; capture both candidates. |
| UX06 | 1 / M1a | FAIL | Delayed-authoritative case presents intermediate; fast-ready final skips separately labelled; preserve gate | [U U3](UI_CHECK_REPORT.md#u3--p2-promotion-box-shifts-and-intermediate-tier-not-observed): ranks [0,0,0,0,0,2]; existing intermediate gate failed, actual intermediate presentation unmeasured. |
