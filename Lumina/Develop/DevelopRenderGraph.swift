...
///    Interactive pins decode to camera WB + 0 EV, **realizes that demosaic to
///    a bitmap**, then applies exposure / WB as CI post-ops. Settled / export
///    still bake live intent on the filter.
