...
**Pointer parity gaps (rulings needed):** shift-click range select · pointer ✓/✕ mark targets (D47/A3 UI absent).

**Instrument reading (Linux):**

| Command | Result |
|---------|--------|
| `python3 Scripts/harness/run.py fast` | **PASS** 6366ms · orchestration **33/33** |
